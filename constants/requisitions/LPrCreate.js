class LPrCreate {
    ...
    static NON_CATALOG_SHIPPING_MODE = "#select2-shippingmodeid-container";
    static SHIPPING_MODE_SEARCH = ".select2-search__field";
    static QUOTATION_REQUIRED_BY = "//*[@id='dates']/div[1]/input[2]";
    static EXPECTED_PO_ISSUE_CATALOG = "//*[@id='dates']/div[1]/input[2]";
    static EXPECTED_PO_ISSUE_NON_CATALOG = "//*[@id='dates']/div[2]/input[2]";
    static EXPECTED_DELIVERY_CATALOG = "//*[@id='dates']/div[2]/input[2]";
    static EXPECTED_DELIVERY_NON_CATALOG = "//*[@id='dates']/div[3]/input[2]";
    ...
    static CATALOG_ORDER_INTAKE = "#orderInTakeId";
    static NON_CATALOG_ORDER_INTAKE = "#orderintakeid";
    ...
    static CATALOG_INSPECTION_REQUIRED = "#inspectRequired";
    static NON_CATALOG_INSPECTION_REQUIRED = "#inspectrequired";
    ...
    static CATALOG_ITEMS_CONTAINER = "#select2-itemId-container";
    static NON_CATALOG_ITEMS_CONTAINER = "#select2-itemid-container";
    ...
    static CONTINUE_BUTTON = "#submitAttachmentsId";
